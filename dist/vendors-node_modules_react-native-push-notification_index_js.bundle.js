(self["webpackChunkVooDooSmart"] = self["webpackChunkVooDooSmart"] || []).push([["vendors-node_modules_react-native-push-notification_index_js"],{

/***/ "./node_modules/react-native-push-notification/component/index.js":
/*!************************************************************************!*\
  !*** ./node_modules/react-native-push-notification/component/index.js ***!
  \************************************************************************/
/***/ ((module) => {
...
/* harmony import */ var react_native__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react-native */ "./node_modules/react-native-web/dist/exports/AppState/index.js");
...
/* harmony import */ var _component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./component */ "./node_modules/react-native-push-notification/component/index.js");
...
const Notifications = {
  handler: _component__WEBPACK_IMPORTED_MODULE_2__.component,
  onRegister: false,
...
Notifications.configure = function(options) {
  ...
  if ( this.isLoaded === false ) {
    ...
    react_native__WEBPACK_IMPORTED_MODULE_1__["default"].OS === 'android' ? this.callNative( 'addEventListener', [ 'action', this._onAction ] ) : null
    react_native__WEBPACK_IMPORTED_MODULE_1__["default"].OS === 'android' ? this.callNative( 'addEventListener', [ 'remoteFetch', this._onRemoteFetch ] ) : null
  ...
  react_native__WEBPACK_IMPORTED_MODULE_0__["default"].addEventListener('change', handlePopInitialNotification.bind(this));

  handlePopInitialNotification(react_native__WEBPACK_IMPORTED_MODULE_0__["default"].currentState);
...
Notifications.unregister = function() {
  ...
  react_native__WEBPACK_IMPORTED_MODULE_1__["default"].OS === 'android' ? this.callNative( 'removeEventListener', [ 'action', this._onAction ] ) : null
  react_native__WEBPACK_IMPORTED_MODULE_1__["default"].OS === 'android' ? this.callNative( 'removeEventListener', [ 'remoteFetch', this._onRemoteFetch ] ) : null
  this.isLoaded = false;
};
...
Notifications.localNotification = function({...details}) {
  if ('android' === react_native__WEBPACK_IMPORTED_MODULE_1__["default"].OS && details && !details.channelId) {
  ...
  if (react_native__WEBPACK_IMPORTED_MODULE_1__["default"].OS === 'ios') {
...
Notifications._onRegister = function(token) {
  if ( this.onRegister !== false ) {
    this.onRegister({
      token: token,
      os: react_native__WEBPACK_IMPORTED_MODULE_1__["default"].OS
    });
  }
};
...
Notifications._transformNotificationObject = function(data, isFromBackground = null) {
  ...
  if ( isFromBackground === null ) {
    isFromBackground = (
      ...
      react_native__WEBPACK_IMPORTED_MODULE_0__["default"].currentState === 'background' ||
      react_native__WEBPACK_IMPORTED_MODULE_0__["default"].currentState === 'unknown'
    );
  }
...
Notifications._requestPermissions = function() {
  ...
  } else if (react_native__WEBPACK_IMPORTED_MODULE_1__["default"].OS === 'android') {
...
//# sourceMappingURL=vendors-node_modules_react-native-push-notification_index_js.bundle.js.map